...
class Festa:
    def __init__(self, musica, comida, local, decoracao, Nome):
        ...
        self.pontos = 20
        self.Nome = Nome
#convidados e pontos foram criados fora dos parenteses para que eu possa criar uma fesdta sem criar convidados
...
# 🎯 CAPÍTULO 2: Nossa Plateia/convidado
# aqui craimos uma funcionalidade que gera os gostos dos convidados aleatoeriamente
class Convidado:
    def __init__(self):
...
# aqui foi utilizado Polimorfismo essa função utiliza recursos já da festa
...
#usando while faz com que eu consiga escolher uma das funções abaixos sem encerrar o codigo ou dar erro caso coloque uma opção errada
while True:
    print(f"\n===== FESTA {f.Nome} =====")
